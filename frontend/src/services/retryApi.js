...
const API_BASE_URL = import.meta.env.VITE_API_URL || (typeof window !== 'undefined' && window.location.hostname === '13.48.136.109' ? "http://13.48.136.109:5000" : "http://localhost:5000");
